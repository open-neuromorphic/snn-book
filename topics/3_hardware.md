...
The BrainScaleS system is an analogue neural emulator i.e. the neurons a re physical electronic circuits that emulated a neural model in terms of how they react when spikes are applied.
