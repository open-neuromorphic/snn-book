...
chapter [](#chapter:neuron) starts by explaining what we mean by a "neuron" and
chapter [](#chapter:spiking) extends that to spiking neuron models.
We then put several spiking neurons together into to *spiking neural networks* (SNNs) in "[](#chapter:snn) and, finally, discuss some modeling theories from computational neuroscience that are relevant when you think and work with SNNs.
