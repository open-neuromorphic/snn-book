\section{Misc-1}
Following are the examples of tables where a template of the table is first created, followed by using the same template to create the following tables.
