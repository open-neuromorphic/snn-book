...
\titleformat{\part}[display]
  {}
  {}
  {0pt} % RG- Controls the space between Part Title and orange ribbon.
  ...
  \end{tikzpicture}
  %\fontsize{48}{60}\headingfontfamily\color{fg}\MakeUppercase} % Original.
  \fontsize{36}{60}\headingfontfamily\color{fg}\MakeUppercase}
