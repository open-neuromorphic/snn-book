...
\usetikzlibrary{arrows, backgrounds, calc, fit, math, mindmap, positioning, shapes, shapes.geometric, tikzmark, snakes, arrows.meta}
...
\tikzstyle{cstm-arrow} = [ % RG: Custom arrow definition.
    ->,
    >=stealth,
    draw=border,
    very thick]

\tikzstyle{cstm-label} = [ % RG: Custom label definition.
    text centered,
    text=fg,
    very thick]
